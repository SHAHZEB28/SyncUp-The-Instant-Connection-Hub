...
// TLS options for secure Redis connection on Render/Upstash
...
const formatMessageForFrontend = (messageDoc: any) => {
    ...
    const { _id, __v, ...rest } = messageObject;
            ...
            case 'chat':
                if (ws.currentRoom) {
                    const messagePayload = {
                        ...
                        sender: { id: ws.userId, name: ws.username, avatar: `https://i.pravatar.cc/40?u=${ws.userId}` },
