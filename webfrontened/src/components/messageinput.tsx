...
interface MessageInputProps {
  ...
  // Make these props optional with default implementations
  onStartTyping?: () => void;
  onStopTyping?: () => void;
}
...
export const MessageInput: React.FC<MessageInputProps> = ({ 
  onSend, 
  onStartTyping = () => {}, // Default empty function
  onStopTyping = () => {}  // Default empty function
}) => {
    ...
    useEffect(() => {
        if (input) {
            ...
            // Set a new timeout to notify when typing stops
